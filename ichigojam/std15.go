...
func (self *Std15) DrawChar (screen *ebiten.Image, cx int32, cy int32, c byte) {
...
func (self *Std15) DrawScreen (screen *ebiten.Image) {
  screen.Fill(color.Black)
  for y := int32(0); y < self.buffH; y++ {
    for x := int32(0); x < self.buffW; x++ {
      self.DrawChar(screen, x, y, self.Scr(x,y))
    }
  }
}
